...
DATA_PATH = "C:\\Users\\ASUS\\Downloads\\\Model_1\\\files (2)\\Hinglish_Symptoms_Reference_v3_no_vet_sorted.csv"
MODEL_OUT = "C:\\Users\\ASUS\\Downloads\\\Model_1\\\files (2)\\symptom_specialist_classifier.joblib"
RANDOM_STATE = 42
...
def predict(text: str, bundle_path: str = MODEL_OUT):
    ...
    for a new piece of Hinglish symptom text."""
